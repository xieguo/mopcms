...
class helper_httpdown
{
    ...
    //初始化系统
    private function PrivateInit($url)
    {
        if($url=='') {
            return ;
        }
    ...
    //开始HTTP会话
    private function PrivateStartSession($requestType="GET")
    {
    ...
    //打开连接
    private function PrivateOpenHost()
    {
        if($this->m_host==""){
            return false;
        }
